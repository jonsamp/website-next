  ...
  return (
    ...
    >
      ...
      <main className={styles.main}>
          ...
          <p>Once I received it, I started making shots with it. One thing I noticed was that when I ground at +2 to +3 from the touch point, the shots would run way too fast. Also looking at the ground coffee, it was most very coarse, but with some fines as well. Here's the Decent's graph from a shot I pulled at +0.5 from the touch point. Note: I was using a medium/light roast from PTs Coffee and doing WDT to break up any clumps.</p>
          ...
          <p>Okay, so, becuase of help I got on Twitter from you in a DM, I decided to do a marker test. You all suggested I get a torque wrench, but I don't know which one, and they are easily $75+, so I decided to try without.</p>
          ...
          <p>Yikes! This burr is misaligned. Even spinning it, I could tell visually that the burr was touching on one side and not the other. While I was at it, I also noticed that the burrs may be misaligned such that the two circles do not line up. It's subtle, but in the first picture here you can see the green marker I uses and the teeth of the stationary burr:</p>
          ...
          <p>So, after all of this, I continued to do the marker test, and it took me far to long to realize that I could use the screws to adjust the burrs instead of using shims (I am a creature of habit). And I finally got a clean test. The burrs are now aligned. Look at this graph, this is some good stuff! I can confirm this coffee was <em>much</em> better than anything before.</p>
          ...
          <ul>
            <li>I have a new touch point now, but there's no way to get the sticker off cleanely. Wish I had some more stickers.</li>
